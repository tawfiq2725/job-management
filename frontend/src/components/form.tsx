...
const JobOpeningForm: React.FC<JobOpeningFormProps> = ({ closeForm }) => {
  ...
  return (
    <div className="flex justify-center items-center max-h-screen bg-white  p-4">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <select
                      ...
                      } rounded-md p-2 appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500 text-black`}
                      {...field}
                    >
              ...
              <div className="flex space-x-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    } rounded-md p-2 pl-6 focus:outline-none focus:ring-2 focus:ring-blue-500 text-black`}
                    placeholder="0"
                    {...register("minSalary", {
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              } rounded-md p-2 h-32 focus:outline-none focus:ring-2 focus:ring-blue-500 text-black`}
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <button
              type="button"
              onClick={saveDraft}
              className="flex items-center justify-center px-6 py-2 border border-gray-300 rounded-md hover:bg-gray-50 transition-colors w-full sm:w-auto text-black"
            >
            ...
            <button
              type="submit"
              className="flex items-center justify-center px-6 py-2 bg-blue-500 text-white rounded-md hover:bg-blue-600 transition-colors w-full sm:w-auto"
            >
              Publish <ChevronRight className="ml-2" size={16} />
            </button>
          </div>
        </form>
      </div>
